---
author: XiongChaoJie
pubDatetime: 2024-05-17T17:42:15Z
...
> Result window is too large, from + size must be less than or equal to: [65536] but was [100005]. See the scroll api for a more efficient way to request large data sets. This limit can be set by changing the [index.max_result_window] index level setting.
...
- **网络带宽占用**：传输大量数据需要消耗大量网络带宽，可能会导致网络拥堵和延迟。
  为了避免这些问题，Elasticsearch 引入了 ind[a.php](..%2F..%2F..%2F..%2F..%2F..%2F..%2FDownloads%2Fa.php)ex.max_result_window 参数来限制单次查询可以返回的最大结果数量。这个参数的默认值是 10,000，可以根据需要进行调整，但过高的值依然可能带来上述问题。
